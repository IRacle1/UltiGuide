...
For $t_(g e n)$ seconds of PG you get $t_(g e n) dot p_(g e n)$ power percentage, PG works with 2 noise, so music man progress by $t_(g e n)t dot m_(h m)(2, 20)$ value.
...
We got that power drain for SV exceeds PG. However Music Man has progress decrease when there is no noise, maybe it helps decreasing Music Man progress? Well, no. If you play without PG and fan, using AC for coolingm, making minimal noise, playing perfectly with Lolbit and Phone Guy, Music Man still will be progress by AC noise. His calming down on hard mode is disproportionately small, compared to the progress gain. So there is no way to globally calm MM without using SV. That fact already makes 'old' strategy unoptimal powerwise. 
