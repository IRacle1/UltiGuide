...
`ulti npg` $approx$ `ulti old strat` $lt.tilde$ `ulti 4` $lt.tilde$ `ulti nf` $approx$ `ulti 7` $lt$ `ulti nf npg` $approx$ `ulti 8` $lt.double$ \ $lt.double$ `ulti 12` $lt.double$ `ulti 14` $lt.tilde$ `ulti pgan` $lt.tilde$ `ulti pgan npg`